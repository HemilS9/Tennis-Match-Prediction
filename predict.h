...
Parameters to use in training (to create general ELO score for players):
- score (30%)
- world rank (25%)
- time taken (10%)
- aces (10%)
...
class Match {
    ...
    int l_rank_in, int w_bp_saved_in, double w_bp_faced_in, int l_bp_saved_in, double l_bp_faced_in)
